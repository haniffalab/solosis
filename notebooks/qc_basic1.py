...
def process_sample(sample_name):
    ...
    ########################
    # repo_dir = os.getenv("SOLOSIS_BASE")
    # SOLOSIS_BASE = /software/cellgen/team298/shared/solosis/0.3.0
    ########################
    ...
    x = list(
        Path(
            os.path.join(
                team_data_dir,
                sample_name,
                "cellranger/cellranger710_count_46541_HCA_SkO13260142_GRCh38-2020-A/",
            )
